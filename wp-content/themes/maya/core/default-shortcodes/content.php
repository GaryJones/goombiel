...
function yiw_sc_success_func($atts, $content = null) {
	$html = "<div class=\"sc-box success-box\">".do_shortcode($content)."</div>";
...
function yiw_sc_arrow_func($atts, $content = null) {
	$html = "<div class=\"sc-box arrow-box\">".do_shortcode($content)."</div>";
...
function yiw_sc_alert_func($atts, $content = null) {
	$html = "<div class=\"sc-box alert-box\">".do_shortcode($content)."</div>";
...
function yiw_sc_error_func($atts, $content = null) {
	$html = "<div class=\"sc-box error-box\">".do_shortcode($content)."</div>";
...
function yiw_sc_notice_func($atts, $content = null) {
	$html = "<div class=\"sc-box notice-box\">".do_shortcode($content)."</div>";
...
function yiw_sc_info_func($atts, $content = null) {
	$html = "<div class=\"sc-box info-box\">".do_shortcode($content)."</div>";
