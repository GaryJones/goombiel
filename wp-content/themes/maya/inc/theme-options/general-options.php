...
$yiw_options['general'] = array (      
    ...
    'header' => array(
        ...
        array( "name" => __("Holiday mode", 'yiw'),
        ...
        array( "name" => __("Holiday style", 'yiw'),
...
//                'std' => ''),
    ...
    'shop' => array(
        ...
        array( 'name' => __('Show sorting dropdown', 'yiw'),
            'desc' => __('Select if you want to show the sorting dropdown on products pages.', 'yiw'),
            'id' => 'shop_show_woocommerce_ordering',
            'type' => 'on-off',
            'std' => true),
    ...
    'sitemap' => array(
        ...
        array( 'desc' => '<strong>' . __('Products Settings', 'yiw') . '</strong><br />This settings will applied only if Woocommerce is enabled.',
            'type' => 'simple-text'),
        array(
        ...
        array( 'desc' => '<strong>' . __('Sitemap Settings', 'yiw') . '</strong><br />Choose the elements to include/exclude in your sitemap and the order in which they will be displayed.',
            'type' => 'simple-text'),
        array(
            'id'   => 'sitemap-order',
            'type' => 'connectedlist',
    ...
    'popup' => array(
        ...
        array( 'name' => __('Popup Title', 'yiw'),
            'desc' => __('Enter the title', 'yiw'),
            'id' => 'popup_title',
            'type' => 'text',
            'std' => '' ),
        array( 'name' => __('Popup Image', 'yiw'),
            'desc' => __("Upload an image", 'yiw'),
            'id' => 'popup_image',
            'type' => 'upload',
            'std' => ''),
        array( 'name' => __('Popup Message', 'yiw'),
