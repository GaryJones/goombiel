...
if( !class_exists( 'YITH_WCWL_UI' ) ) {
    class YITH_WCWL_UI {
        ...
        public static function add_to_wishlist_button( $url, $product_type, $exists ) {   
            ...
            $html .= '<div class="yith-wcwl-wishlistaddedbrowse" style="display:none;"><span class="feedback">' . __( 'Product added!','yiw' ) . '</span> <a href="' . $url . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yiw' ) ) . '</a></div>';
            $html .= '<div class="yith-wcwl-wishlistexistsbrowse" style="display:' . ( $exists ? 'block' : 'none' ) . '"><span class="feedback">' . __( 'The product is already in the wishlist!', 'yiw' ) . '</span> <a href="' . $url . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yiw' ) ) . '</a></div>';
        ...
        public static function get_share_links( $url ) {
            ...
            $html .= apply_filters( 'yith_wcwl_socials_share_title', '<h4>' . __( 'Share on:', 'yiw' ) . '</h4>' );
                $html .= '<ul>';
                
                if( get_option( 'yith_wcwl_share_fb' ) == 'yes' )
                    { $html .= '<li style="list-style-type: none; display: inline-block;"><a target="_blank" class="facebook" href="https://www.facebook.com/sharer.php?s=100&amp;p[title]=' . $title . '&amp;p[url]=' . $url . '&amp;p[summary]=' . $summary . '&amp;p[images][0]=' . $imageurl . '" title="' . __( 'Facebook', 'yiw' ) . '"></a></li>'; }
                
                if( get_option( 'yith_wcwl_share_twitter' ) == 'yes' )
                    { $html .= '<li style="list-style-type: none; display: inline-block;"><a target="_blank" class="twitter" href="https://twitter.com/share?url=' . $url . '&amp;text=' . $twitter_summary . '" title="' . __( 'Twitter', 'yiw' ) . '"></a></li>'; }
