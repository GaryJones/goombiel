...
if( !class_exists( 'YITH_WCWL_Init' ) ) {
    ...
    class YITH_WCWL_Init {
        ...
        public function add_page_setting_woocommerce( $settings ) {
            ...
            $settings[] = array(
                'name' => __( 'Wishlist Page', 'yiw' ),
        		'desc' 		=> __( 'Page contents: [yith_wcwl_wishlist]', 'yiw' ),
        ...
        public function print_plugin_options() {
            $links = apply_filters( 'yith_wcwl_tab_links', array(
                '<a href="#yith_wcwl_general_settings">' . __( 'General Settings', 'yiw' ) . '</a>',
                '<a href="#yith_wcwl_styles">' . __( 'Styles', 'yiw' ) . '</a>',
                '<a href="#yith_wcwl_socials_share">' . __( 'Socials &amp; Share', 'yiw' ) . '</a>',
            ) );
        ...
        private function _styles_options() {
            ...
            yith_frontend_css_color_picker( __( '"Add to Wishlist" button background', 'yiw' ), 'yith_wcwl_color_add_to_wishlist_background', $colors['add_to_wishlist']['background'] );
            yith_frontend_css_color_picker( __( '"Add to Wishlist" button text', 'yiw' ), 'yith_wcwl_color_add_to_wishlist_color', $colors['add_to_wishlist']['color'] );
            yith_frontend_css_color_picker( __( '"Add to Wishlist" button border', 'yiw' ), 'yith_wcwl_color_add_to_wishlist_border_color', $colors['add_to_wishlist']['border_color'] );
            
            ?><div class="clear" style="height:10px;"></div><?php
            
            yith_frontend_css_color_picker( __( '"Add to Cart" button background', 'yiw' ), 'yith_wcwl_color_add_to_cart_background', $colors['add_to_cart']['background'] );
            yith_frontend_css_color_picker( __( '"Add to Cart" button text', 'yiw' ), 'yith_wcwl_color_add_to_cart_color', $colors['add_to_cart']['color'] );
            yith_frontend_css_color_picker( __( '"Add to Cart" button border', 'yiw' ), 'yith_wcwl_color_add_to_cart_border_color', $colors['add_to_cart']['border_color'] );
            
            ?><div class="clear" style="height:10px;"></div><?php
            
            yith_frontend_css_color_picker( __( 'Wishlist table background', 'yiw' ), 'yith_wcwl_color_wishlist_table_background', $colors['wishlist_table']['background'] );
            yith_frontend_css_color_picker( __( 'Wishlist table text', 'yiw' ), 'yith_wcwl_color_wishlist_table_color', $colors['wishlist_table']['color'] );
            yith_frontend_css_color_picker( __( 'Wishlist table border', 'yiw' ), 'yith_wcwl_color_wishlist_table_border_color', $colors['wishlist_table']['border_color'] );
        ...
        private function _plugin_options() {
            ...
            $options['general_settings'] = array(
                array( 'name' => __( 'General Settings', 'yiw' ), 'type' => 'title', 'desc' => '', 'id' => 'yith_wcwl_general_settings' ),
                
                array(
                    'name'      => __( 'Enable YITH Wishlist', 'yiw' ),
                    'desc'      => __( 'Enable all plugin features. <strong>Be sure that the wishlist page is selected in WooCommerce &gt; Settings &gt; Pages.</strong> Also, please read the plugin <a href="http://yithemes.com/docs/YITH_WCWL/" target="_blank">documentation</a>.', 'yiw' ), 
                ...
                array(
                    'name'      => __( 'Use cookies', 'yiw' ),
                    'desc'      => __( 'Use cookies instead of sessions. With this feature, the wishlist will be available for each not logged user for 30 days. Use the filter yith_wcwl_cookie_expiration_time to change the expiration time ( needs timestamp ).', 'yiw' ), 
                ...
                array(
                    'name'      => __( 'Wishlist title', 'yiw' ),
            		'id' 		=> 'yith_wcwl_wishlist_title',
            		'std' 		=> sprintf( __( 'My wishlist on %s', 'yiw' ), get_bloginfo( 'name' ) ),
            		'default' 	=> sprintf( __( 'My wishlist on %s', 'yit' ), get_bloginfo( 'name' ) ),         // for woocommerce >= 2.0
            		'type' 		=> 'text',
            		'css' 		=> 'min-width:300px;',
                ),
                array(
                    'name'      => __( 'Position', 'yiw' ),
                    'desc'      => __( 'On variable products you can add it only After "Add to Cart" or use the shortcode [yith_wcwl_add_to_wishlist].', 'yiw' ),
                    'id'        => 'yith_wcwl_button_position',
                    'type'      => 'select',
                    'class'		=> 'chosen_select',
                    'css' 		=> 'min-width:300px;',
                    'options'   => array(
                        'add-to-cart' => __( 'After "Add to cart"', 'yiw' ),
                        'thumbnails' => __( 'After thumbnails', 'yiw' ),
                        'summary'   => __( 'After summary', 'yiw' ),
                        'shortcode' => __( 'Use shortcode', 'yiw' )
                    ),
                    'desc_tip'	=>  false
                ),
                array(
                    'name'      => __( 'Redirect to cart', 'yiw' ),
                    'desc'      => __( 'Redirect to cart page if "Add to cart" button is clicked in the wishlist page.', 'yiw' ), 
                ...
                array(
                    'name'      => __( 'Remove if added to the cart', 'yiw' ),
                    'desc'      => __( 'Remove the product from the wishlist if is been added to the cart.', 'yiw' ), 
                ...
                array(
                    'name'      => __( '"Add to Wishlist" text', 'yiw' ),
            		'id' 		=> 'yith_wcwl_add_to_wishlist_text',
            		'std' 		=> __( 'Add to Wishlist', 'yiw' ),
            		'default' 	=> __( 'Add to Wishlist', 'yiw' ),         // for woocommerce >= 2.0
            		'type' 		=> 'text',
            		'css' 		=> 'min-width:300px;',
                ),
                array(
                    'name'      => __( '"Add to Cart" text', 'yiw' ),
            		'id' 		=> 'yith_wcwl_add_to_cart_text',
            		'std' 		=> __( 'Add to Cart', 'yiw' ),
            		'default' 	=> __( 'Add to Cart', 'yiw' ),         // for woocommerce >= 2.0
            		'type' 		=> 'text',
            		'css' 		=> 'min-width:300px;',
                ),
            ...
            $options['styles'] = array(
                array( 'name' => __( 'Styles', 'yiw' ), 'type' => 'title', 'desc' => '', 'id' => 'yith_wcwl_styles' ),
                
                array(
                    'name'      => __( 'Use buttons', 'yiw' ),
                    'desc'      => __( 'Use buttons instead of a simple anchors.', 'yiw' ), 
                ...
                array(
                    'name'      => __( 'Use theme style', 'yiw' ),
                    'desc'      => __( 'Use the theme style.', 'yiw' ), 
                ...
                array(
                    'name'      => __( 'Buttons rounded corners', 'yiw' ),
                    'desc'      => __( 'Make buttons corner rounded', 'yiw' ), 
                ...
                array( 
                    'name'      => __( '"Add to Wishlist" icon', 'yiw' ),
            		'desc' 		=> __( 'Add an icon to the "Add to Wishlist" button', 'yiw' ),
                ...
                array( 
                    'name'      => __( '"Add to Cart" icon', 'yiw' ),
            		'desc' 		=> __( 'Add an icon to the "Add to Cart" button', 'yiw' ),
            ...
            $options['socials_share'] = array(
                array( 'name' => __( 'Socials &amp; Share', 'yiw' ), 'type' => 'title', 'desc' => '', 'id' => 'yith_wcwl_socials_share' ),
                
                array(
                    'name'      => __( 'Share on Facebook', 'yiw' ),
                ...
                array(
                    'name'      => __( 'Socials text', 'yiw' ),
                    'desc'      => __( 'Will be used by Facebook, Twitter and Pinterest. Use <strong>%wishlist_url%</strong> where you want the URL of your wishlist to appear.', 'yiw' ),
