       				<?php $has_thumbnail = ( ! has_post_thumbnail() || ( ! is_single() && ! yiw_get_option( 'show_featured_blog', 1 ) ) || ( get_post_type() == 'post' && is_single() && ! yiw_get_option( 'show_featured_single', 1 ) ) ) ? false : true; ?>
